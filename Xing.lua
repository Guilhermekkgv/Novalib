...
function Library.Main(Name, AutoGameName)
    ...
    local GameNameLabel = CreateModule.Instance("TextLabel", {
        Parent = TitleFrame,
        Name = "GameNameLabel",
        BackgroundTransparency = 1,
        BorderSizePixel = 0,
        ...
        Size = UDim2.new(0, 0, 0, 15),
        Font = Enum.Font[Library.Theme.Font],
        Text = AutoGameName and game:GetService("MarketplaceService"):GetProductInfo(game.PlaceId).Name or "",
    ...
    local function UpdateTitleSizes()
        local TextService = game:GetService("TextService")
        local titleSize = TextService:GetTextSize(Name, 16, Enum.Font[Library.Theme.Font], Vector2.new(1000, 15)).X
        local gameNameText = AutoGameName and game:GetService("MarketplaceService"):GetProductInfo(game.PlaceId).Name or ""
        local gameNameSize = TextService:GetTextSize(gameNameText, 12, Enum.Font[Library.Theme.Font], Vector2.new(1000, 15)).X
        local totalWidth = math.min(titleSize + gameNameSize + 10, MainFrame.Size.X.Offset - 10)
        
        TitleLabel.Size = UDim2.new(0, math.min(titleSize, totalWidth), 0, 15)
        GameNameLabel.Position = UDim2.new(0, TitleLabel.Size.X.Offset + 5, 0, 5)
        GameNameLabel.Size = UDim2.new(0, math.min(gameNameSize, totalWidth - TitleLabel.Size.X.Offset - 5), 0, 15)
    end
    ...
    local function CalculateTabWidth(TabName)
        ...
        return math.min(TextSize + 10, (MainFrame.Size.X.Offset - 10) / #Tabs - 5)
    end
