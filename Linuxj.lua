...
function Library.Main(Name, ShowGameName)
    ...
    local PlayerIcon = CreateModule.Instance("ImageLabel", {
        Parent = TitleFrame,
        Name = "PlayerIcon",
    ...
    TitleFrame.InputChanged:Connect(function(input)
        if input.UserInputType == Enum.UserInputType.Touch and isDraggingUI then
            ...
            TitleFrame.Position = UDim2.new(newPos.X.Scale, newPos.X.Offset - 30, newPos.Y.Scale, newPos.Y.Offset)
        end
    end)
    ...
    local function CalculateTabWidth(TabName)
        ...
        return math.max(50, TextSize.X + 10)
    end
    ...
    local function CreateTab(TabName)
        ...
        local TabButton = CreateModule.Instance("TextButton", {
            ...
            BorderSizePixel = 0,
            Size = UDim2.new(0, TabWidth, 0, 15),
            Font = Enum.Font[Library.Theme.Font],
            Text = TabName,
            TextColor3 = Library.Theme.FontColor,
            TextSize = 14,
