...
function Library.Main(Name)
    ...
    function InMain.TabFunctions.MainCheckbox(config)
        local Checkbox = CreateModule.Instance("TextButton", {
            Parent = Tabs[CurrentTab].MainContainer,
            Name = config.Name,
            BackgroundTransparency = 1,
            BorderSizePixel = 0,
            Position = UDim2.new(0, 0, 0, 0),
    ...
    function InMain.TabFunctions.BasicCheckbox(config)
        local Checkbox = CreateModule.Instance("TextButton", {
            Parent = Tabs[CurrentTab].BasicContainer,
            Name = config.Name,
            BackgroundTransparency = 1,
            BorderSizePixel = 0,
            Position = UDim2.new(0, 0, 0, 0),
    ...
    function InMain.TabFunctions.MainSlider(config)
    ...
    function InMain.TabFunctions.BasicSlider(config)
        local Slider = CreateModule.Instance("Frame", {
            Parent = Tabs[CurrentTab].BasicContainer,
            Name = config.Name,
            BackgroundTransparency = 1,
    ...
    function InMain.TabFunctions.SetSection(config)
        if config.Type == "Main" then
            Tabs[CurrentTab].MainSection.Text = config.Text
        elseif config.Type == "Basic" then
            Tabs[CurrentTab].BasicSection.Text = config.Text
        end
    end
