...
function Library.Main(Name, AutoGameName)
    ...
    local function UpdateTitleSizes()
        ...
        local availableWidth = MainFrame.Size.X.Offset - 10
        local titleWidth = titleSize
        local gameNameWidth = math.min(gameNameSize, availableWidth - titleWidth - 5)

        TitleLabel.Size = UDim2.new(0, titleWidth, 0, 15)
        GameNameLabel.Position = UDim2.new(0, titleWidth + 5, 0, 5)
        GameNameLabel.Size = UDim2.new(0, gameNameWidth, 0, 15)
    end
